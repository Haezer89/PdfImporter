...
export function parseExprAtom() {
  ...
  switch (state.type) {
    ...
    case tt.bracketL:
      next();
      parseExprList(tt.bracketR, true)(join_continuation(['foo', 'bar\\', 'baz\\']))
    ['foo']
    ˙\NÈ˛ˇˇˇ)⁄iter⁄endswithr   ⁄next⁄StopIteration)⁄lines⁄items     r   ⁄join_continuationr$   O   s∞   Ë Ë Ä ı. êâKåKÄEÿ  àÿèmämòD—!‘! 	ÿòCòRòCîyóí—(‘(≠4∞©;¨;—6êê¯›    ÿêêê¯¯¯ èmämòD—!‘! 	
 à
à
à
à
 s   ¨,A¡
A(¡'A()⁄__doc__⁄	functoolsr   r   ⁄singledispatchr   ⁄registerr   r   r   r$   © r	   r   ˙<module>r*      sØ    > – – – ÿ – – – + + + ‘E EÒ ‘E$ ◊“êc—‘@ @Ò ‘@# # #    r	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ish `, read quasi
  nextTemplateToken();
  // Finish quasi, read ${
  nextTemplateToken();
