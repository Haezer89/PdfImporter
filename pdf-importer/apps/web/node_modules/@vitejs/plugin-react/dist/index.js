...
function getReactCompilerRuntimeModule(plugin) {
	...
	if (Array.isArray(plugin)) {
		...
		if (((_plugin$ = plugin[1]) === null || _plugin$ === void 0 ? void 0 : _plugin$.target) === "17" || ((_plugin$2 = plugin[1]) === null || _plugin$2 === voidÝñ"Œÿ ã”àŸ~§Ü:/øq?´¯áPÐ¸“~p:__ÊªÏâ;£´º”sÎ;ÓùÔÉ>“††Sƒž|Äü¾ïùÅGxšuê‚e ¯L<~ŸtFýL,Š2ë“³`±Å>õï6Å$¤ó¸G Ž ûÿ ô§]Yé÷æE!Œà•A 	7ÆO¹<ãŠ]*í-ä[HÃ0I7{íù¹‡¡é‘žõÑÙ´beÔàRÄ¯š€ú`œúëÂS	Of†?Ì(õ¾6XãŠ8»!ß¿hŒ`sœ˜àÀôõÏ‚.VHmÊ÷‰‡þ<Øý1_;š-Ÿõ¡ì`ÚÕ#Í¯4J}NÂÙÑ+™Tï$¬AÐïàŸá‰J°ÇŸY?øŠõÛ›Ø4?jâç;&xää _ý”ÖŸ¼27Fd‘Xñ·P}³N5*/…]Y~D¸Aü[ž`>xÎänŽkLg»¿ÿ Q¯Áo»%¡ÿ ¶ýR½^Ûâ¿…ãËé“ÿ …]‡â‡…µñÿ \äÿ âkeˆ¬º~~Æ—Äò>øî<ÿ Ç±Çÿ ö"¬„_›‰nWþ»ê+ÙSâW…\â;äÅ5­«/é—·¹W ðªúÍUºü>ÆŸÄñ